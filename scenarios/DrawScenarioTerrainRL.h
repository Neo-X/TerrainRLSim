...
protected:
	...
	/// These may cause delete errors now..
	std::shared_ptr<cShader> mShaderMesh;
	std::shared_ptr<cShader> mLambertShaderMesh;
	std::shared_ptr<cShader> mShaderDepth;
	std::shared_ptr<cShader> mShaderHBAO;
	std::shared_ptr<cShader> mShaderGBuffer;
	std::shared_ptr<cShader> mShaderSSR;
	std::shared_ptr<cShader> mShaderApplySSR;
	...
	GLuint mLambertProjectionMatHandle;
