#include "ScenarioSpaceMultChar.h"
...
cScenarioSpaceMultChar::cScenarioSpaceMultChar() :
...
void cScenarioSpaceMultChar::Init()
{
	cScenarioMultCharConcentricCircle::Init();
}

void cScenarioSpaceMultChar::ParseMiscArgs(const std::shared_ptr<cArgParser>& parser)
{
	cScenarioMultCharConcentricCircle::ParseMiscArgs(parser);
	
	// parser->ParseInt("num_characters", mNumChars);
	// parser->ParseDouble("spawn_radius", mSpawnRadius);
}

std::string cScenarioSpaceMultChar::GetName() const
{
	return "Scenario Space Like scene generation with Multiple Characters";
}

void cScenarioSpaceMultChar::GenerateInitialTransform(std::shared_ptr<cSimCharacter>& character,
...
tVector cScenarioSpaceMultChar::CalcTargetPosObstaclesDynamicCharacters3D(std::shared_ptr<cSimCharacter>& character)
{
...
void cScenarioSpaceMultChar::Reset()
{
