...
double cScenarioSoccerGeneralEval::CalcReward() const
{
...
void cScenarioSoccerGeneralEval::ParseArgs(const std::shared_ptr<cArgParser>& parser)
{
...
void cScenarioSoccerGeneralEval::Init()
{
...
void cScenarioSoccerGeneralEval::Reset()
{
...
void cScenarioSoccerGeneralEval::Update(double time_elapsed)
{
...
void cScenarioSoccerGeneralEval::ResetParams()
{
	cScenarioExpImitateStep::ResetParams();
	mPrevBallPos.setZero();
}

bool cScenarioSoccerGeneralEval::CheckResetTarget() const
{
	bool reset_target = (mRandTargetPosTimer <= 0);
	return reset_target;
}

void cScenarioSoccerGeneralEval::ClearObjs()
{
	cScenarioExpImitateStep::ClearObjs();
	mBallObjHandles.clear();
}

void cScenarioSoccerGeneralEval::HandleNewActionUpdate()
{
...
bool cScenarioSoccerGeneralEval::EndEpisode() const
{
...
double cScenarioSoccerGeneralEval::GetRandTargetMaxDist() const
{
	return gMaxTargetDist;
}

double cScenarioSoccerGeneralEval::GetRandBallMaxDist() const
{
	return gMaxBallDist;
}

void cScenarioSoccerGeneralEval::BuildBalls()
{
...
int cScenarioSoccerGeneralEval::BuildBall()
{
...
const std::shared_ptr<cSimObj>& cScenarioSoccerGeneralEval::GetBall() const
{
	return GetBall(GetTargetBallHandle());
}

const std::shared_ptr<cSimObj>& cScenarioSoccerGeneralEval::GetBall(int ball_handle) const
{
...
tVector cScenarioSoccerGeneralEval::GetBallPos() const
{
	return GetBallPos(GetTargetBallHandle());
}

tVector cScenarioSoccerGeneralEval::GetBallPos(int ball_handle) const
{
	const auto& ball = GetBall(ball_handle);
	return ball->GetPos();
}

tVector cScenarioSoccerGeneralEval::CalcTargetPosDefault()
{
...
void cScenarioSoccerGeneralEval::UpdateBallPos(double time_elapsed)
{
	int ball_handle = GetTargetBallHandle();
...
void cScenarioSoccerGeneralEval::ResetBallPosAll()
{
...
void cScenarioSoccerGeneralEval::ResetBallPos(int ball_handle)
{
...
void cScenarioSoccerGeneralEval::SetBallPos(const tVector& pos)
{
	SetBallPos(GetTargetBallHandle(), pos);
}

int cScenarioSoccerGeneralEval::GetNumBalls() const
{
	return static_cast<int>(mBallObjHandles.size());
}

void cScenarioSoccerGeneralEval::RemoveObj(int handle)
{
...
void cScenarioSoccerGeneralEval::SetBallPos(int ball_handle, const tVector& pos)
{
	const auto& ball = GetBall(ball_handle);
...
void cScenarioSoccerGeneralEval::ResetBallTimer()
{
	mRandBallPosTimer = mRand.RandDouble(mRandBallPosTimeMin, mRandBallPosTimeMax);
}

int cScenarioSoccerGeneralEval::GetTargetBallHandle() const
{
...
void cScenarioSoccerGeneralEval::UpdateTargetBall()
{
...
int cScenarioSoccerGeneralEval::FindNearestBall(const tVector& pos) const
{
