#include "MultiCharWaypointVelController.h"
#include "sim/GroundDynamicObstacles3D.h"

//#define ENABLE_HEIGHT_MAP

cMultiCharWaypointVelController::cMultiCharWaypointVelController() : cWaypointVelController()
{
	// mGroundOriginVel.setZero();
}

cMultiCharWaypointVelController::~cMultiCharWaypointVelController()
{
}

void cMultiCharWaypointVelController::BuildTargetPosState(Eigen::VectorXd& out_state) const
{
...
void cMultiCharWaypointVelController::ApplyAction(const tAction& action)
{
