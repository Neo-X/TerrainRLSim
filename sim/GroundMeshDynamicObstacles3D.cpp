...
cGroundMeshDynamicObstacles3D::tObstacle::tObstacle()
{
	mPosStart.setZero();
	mPosEnd.setZero();
	mSpeed = 1;
...
void cGroundMeshDynamicObstacles3D::tObstacle::Update(double time_elapsed, const tVector& char_pos)
{
...
tVector cGroundMeshDynamicObstacles3D::tObstacle::CalcPos() const
{
	tVector pos = mObj->GetPos();
	return pos;
}

tVector cGroundMeshDynamicObstacles3D::tObstacle::CalcVel() const
{
	double phase = mPhase;
...
double cGroundMeshDynamicObstacles3D::tObstacle::CalcCycleDur() const
{
...
cGroundMeshDynamicObstacles3D::cGroundMeshDynamicObstacles3D()
{
}
...
void cGroundMeshDynamicObstacles3D::Init(std::shared_ptr<cWorld> world, const tParams& params,
		const tVector& bound_min, const tVector& bound_max)
{
	cGroundObstacles3D::Init(world, params, bound_min, bound_max);
	BuildObstacles();
}

void cGroundMeshDynamicObstacles3D::Clear()
{
	cGroundObstacles3D::Clear();
	ClearObstacles();
}

void cGroundMeshDynamicObstacles3D::Update(double time_elapsed, const tVector& bound_min, const tVector& bound_max)
{
	cGroundObstacles3D::Update(time_elapsed, bound_min, bound_max);
...
int cGroundMeshDynamicObstacles3D::GetNumObstacles() const
{
	return static_cast<int>(mObstacles.size());
}

const cSimObj& cGroundMeshDynamicObstacles3D::GetObj(int i) const
{
	return *mObstacles[i].mObj;
}

double cGroundMeshDynamicObstacles3D::SampleHeight(const tVector& pos, bool& out_valid_sample) const
{
	double h;
	tVector vel;
...
void cGroundMeshDynamicObstacles3D::SampleHeightVel(const tVector& pos, double& out_h, tVector& out_vel,
...
tVector cGroundMeshDynamicObstacles3D::FindRandFlatPos(const tVector& buffer_size)
{
...
void cGroundMeshDynamicObstacles3D::SetChar(const std::shared_ptr<cSimCharacter>& character)
{
	mChar = character;
}

cGroundMeshDynamicObstacles3D::eClass cGroundMeshDynamicObstacles3D::GetGroundClass() const
{
	return eClassObstaclesMeshDynamicCharacters3D;
}

int cGroundMeshDynamicObstacles3D::GetBlendParamSize() const
{
	return static_cast<int>(cTerrainGen3D::eParamsMax);
}

tVector cGroundMeshDynamicObstacles3D::GetCharPos() const
{
	return mChar->GetRootPos();
}

void cGroundMeshDynamicObstacles3D::BuildObstacles()
{
...
void cGroundMeshDynamicObstacles3D::ClearObstacles()
{
	mObstacles.clear();
}

void cGroundMeshDynamicObstacles3D::SortObstacles()
{
...
void cGroundMeshDynamicObstacles3D::BuildObstacle(tObstacle& out_obstacle)
{
...
void cGroundMeshDynamicObstacles3D::UpdateObstacles(double time_elapsed)
{
...
double cGroundMeshDynamicObstacles3D::FindMaxBoundHeight(const tVector& aabb_min, const tVector& aabb_max) const
{
