...
public:
	...
	enum eClass
	{
		...
		eClassObstaclesMeshDynamicCharacters3D,
		eClassDynamicCharacters3D,
	...
	enum eType
	{
		...
		eTypeObstaclesMeshDynamicCharacters3D,
		eTypeDynamicCharacters3D,
	...
	virtual void SampleHeightVel(cSimCharacter* _char, const tVector& pos, double& out_h, tVector& out_vel,
										bool& out_valid_sample) const;
