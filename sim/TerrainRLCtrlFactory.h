...
public:
	...
	enum eCharCtrl
	{
		...
		eCharVelCtrlCrowdVelPosGoalOtherAgentInfo,
...
protected:
	...
	static bool BuildCrowdCharVelGoalVelPosOtherAgentInfoController(const tCtrlParams& params, std::shared_ptr<cCharController>& out_ctrl);
